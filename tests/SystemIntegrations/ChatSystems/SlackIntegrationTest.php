...
class SlackIntegrationTest extends TestCase
{
    ...
    public function testMessageSending () : void
    {
        ...
        $message = self::$slack->getChatMessageThread($tickets, 'Nowhere', 'deploy-message-generator-test', [], [], "<@UFCUGTR98>");
    ...
    public function testMessageSendingLongText () : void
    {
        ...
        $thread = self::$slack->getChatMessageThread($threadTickets, "Nowhere", "deploy-message-generator-test", [], [], "<@UFCUGTR98>");
